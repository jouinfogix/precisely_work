USE [DBA]
GO
/****** Object:  Table [dbo].[Tbl_Activity_History_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Tbl_Activity_History_Monitor](
...
GO
/****** Object:  Table [dbo].[Tbl_CPU_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Tbl_CPU_Monitor](
	[reads] [varchar](30) NULL,
	[writes] [varchar](30) NULL,
	[physical_reads] [varchar](30) NULL,
	[used_memory] [varchar](30) NULL,
...
GO
/****** Object:  Table [dbo].[Tbl_DISk_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Tbl_DISk_Monitor](
	[session_id] [smallint] NOT NULL,
	[writes] [varchar](30) NULL,
	[physical_reads] [varchar](30) NULL,
	[used_memory] [varchar](30) NULL,
...
GO
/****** Object:  Table [dbo].[Tbl_Memory_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Tbl_Memory_Monitor](
	[session_id] [smallint] NOT NULL,
	[sql_text] [xml] NULL,
	[login_name] [nvarchar](128) NOT NULL,
	[wait_info] [nvarchar](4000) NULL,
...
GO
/****** Object:  StoredProcedure [dbo].[Activity_CPU_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
create  procedure [dbo].[Activity_CPU_Monitor]
as
begin
...
GO
/****** Object:  StoredProcedure [dbo].[Activity_History_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE  procedure [dbo].[Activity_History_Monitor]
as
begin
IF((select count(1) from DBA.DBO.Tbl_Activity_History_Monitor
WHERE Start_time < DATEADD(day, -30, GETDATE()))>0)
BEGIN
print 'Deleting 30 Dasys older log'
delete from DBA.DBO.Tbl_Activity_History_Monitor
WHERE Start_time < DATEADD(day, -30, GETDATE())

END


exec DBA.DBO.sp_Activity_log_Collector   @get_outer_command=1
,  @output_column_list = '[dd%][session_id][sql_text][login_name][wait_info][CPU][tempdb_allocations][tempdb_current][blocking_session_id][reads][writes][physical_reads][used_memory][status][open_tran_count][percent_complete][host_name][database_name][program_name][start_time][login_time][request_id][collection_time]'
, @find_block_leaders=1
, @destination_table = 'DBA.DBO.Tbl_Activity_History_Monitor';
end
GO
/****** Object:  StoredProcedure [dbo].[Activity_Memory_Monitor]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
create  procedure [dbo].[Activity_Memory_Monitor]
as
begin
IF((select count(1) from DBA.DBO.Tbl_Activity_History_Monitor
WHERE Start_time < DATEADD(day, -30, GETDATE()))>0)
...
GO
/****** Object:  StoredProcedure [dbo].[sp_Activity_log_Collector]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROC [dbo].[sp_Activity_log_Collector]
(
...
GO
/****** Object:  StoredProcedure [dbo].[sp_Activity_log_History]    Script Date: 08-09-2023 20:24:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE  PROC [dbo].[sp_Activity_log_History]
(
